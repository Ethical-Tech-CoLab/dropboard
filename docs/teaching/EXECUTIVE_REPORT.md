...
- **Repo:** https://github.com/alx-du/dropboard (owner `alx-du`; a fork exists on another account)
- **Live site (GitHub Pages, deployed & green):** https://alx-du.github.io/dropboard/
- **Issues:** 14 backlog (P0/P1/P2) + #15 pick-a-backend decision
